...
[Migration("20260915174315_AddAuditTrail")]
public class AddAuditTrail : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.CreateTable("AuditLogs", delegate(ColumnsBuilder table)
		{
			...
			OperationBuilder<AddColumnOperation> occurredAt = table.Column<DateTime>("datetime2");
			OperationBuilder<AddColumnOperation> correlationId = table.Column<Guid>("uniqueidentifier");
			int? maxLength = 20;
			OperationBuilder<AddColumnOperation> category = table.Column<string>("nvarchar(20)", null, maxLength);
			maxLength = 80;
			OperationBuilder<AddColumnOperation> action = table.Column<string>("nvarchar(80)", null, maxLength);
			maxLength = 20;
			OperationBuilder<AddColumnOperation> severity = table.Column<string>("nvarchar(20)", null, maxLength);
			maxLength = 1000;
			OperationBuilder<AddColumnOperation> summary = table.Column<string>("nvarchar(1000)", null, maxLength, rowVersion: false, null, nullable: true);
			OperationBuilder<AddColumnOperation> isSuccess = table.Column<bool>("bit");
			OperationBuilder<AddColumnOperation> statusCode = table.Column<int>("int", null, null, rowVersion: false, null, nullable: true);
			...
			maxLength = 100;
			OperationBuilder<AddColumnOperation> username = table.Column<string>("nvarchar(100)", null, maxLength, rowVersion: false, null, nullable: true);
			OperationBuilder<AddColumnOperation> businessId = table.Column<Guid>("uniqueidentifier", null, null, rowVersion: false, null, nullable: true);
			OperationBuilder<AddColumnOperation> sessionId = table.Column<Guid>("uniqueidentifier", null, null, rowVersion: false, null, nullable: true);
			maxLength = 200;
			OperationBuilder<AddColumnOperation> deviceToken = table.Column<string>("nvarchar(200)", null, maxLength, rowVersion: false, null, nullable: true);
			maxLength = 100;
			OperationBuilder<AddColumnOperation> entityName = table.Column<string>("nvarchar(100)", null, maxLength, rowVersion: false, null, nullable: true);
			maxLength = 100;
			OperationBuilder<AddColumnOperation> entityId = table.Column<string>("nvarchar(100)", null, maxLength, rowVersion: false, null, nullable: true);
			OperationBuilder<AddColumnOperation> bookId = table.Column<Guid>("uniqueidentifier", null, null, rowVersion: false, null, nullable: true);
			maxLength = 20;
			OperationBuilder<AddColumnOperation> operation = table.Column<string>("nvarchar(20)", null, maxLength, rowVersion: false, null, nullable: true);
			maxLength = 10;
			OperationBuilder<AddColumnOperation> httpMethod = table.Column<string>("nvarchar(10)", null, maxLength, rowVersion: false, null, nullable: true);
			maxLength = 500;
			OperationBuilder<AddColumnOperation> path = table.Column<string>("nvarchar(500)", null, maxLength, rowVersion: false, null, nullable: true);
			maxLength = 2000;
			OperationBuilder<AddColumnOperation> queryString = table.Column<string>("nvarchar(2000)", null, maxLength, rowVersion: false, null, nullable: true);
			maxLength = 64;
			...
			maxLength = 500;
			OperationBuilder<AddColumnOperation> userAgent = table.Column<string>("nvarchar(500)", null, maxLength, rowVersion: false, null, nullable: true);
			OperationBuilder<AddColumnOperation> durationMs = table.Column<long>("bigint", null, null, rowVersion: false, null, nullable: true);
			OperationBuilder<AddColumnOperation> isSlow = table.Column<bool>("bit");
			OperationBuilder<AddColumnOperation> dataJson = table.Column<string>("nvarchar(max)", null, null, rowVersion: false, null, nullable: true);
			maxLength = 2000;
			return new
			{
				Id = id,
				...
				IsSlow = isSlow,
				DataJson = dataJson,
				Error = table.Column<string>("nvarchar(2000)", null, maxLength, rowVersion: false, null, nullable: true)
			};
		}, null, table =>
		{
			table.PrimaryKey("PK_AuditLogs", x => x.Id);
		});
		migrationBuilder.CreateIndex("IX_AuditLogs_Action_Time", "AuditLogs", new string[2] { "Action", "OccurredAt" });
		migrationBuilder.CreateIndex("IX_AuditLogs_Book_Time", "AuditLogs", new string[2] { "BookId", "OccurredAt" });
		migrationBuilder.CreateIndex("IX_AuditLogs_Business_Time", "AuditLogs", new string[2] { "BusinessId", "OccurredAt" });
		migrationBuilder.CreateIndex("IX_AuditLogs_Correlation", "AuditLogs", "CorrelationId");
		migrationBuilder.CreateIndex("IX_AuditLogs_Entity", "AuditLogs", new string[2] { "EntityName", "EntityId" });
		migrationBuilder.CreateIndex("IX_AuditLogs_OccurredAt", "AuditLogs", "OccurredAt");
		migrationBuilder.CreateIndex("IX_AuditLogs_User_Time", "AuditLogs", new string[2] { "UserId", "OccurredAt" });
	}
