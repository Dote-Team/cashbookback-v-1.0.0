...
[Migration("20260915145551_AddTransactionPerformanceIndexes")]
public class AddTransactionPerformanceIndexes : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		Type typeFromHandle = typeof(string);
		migrationBuilder.AlterColumn<string>("Type", "Transactions", "nvarchar(450)", null, null, rowVersion: false, null, nullable: false, null, null, null, typeFromHandle, "nvarchar(max)");
		migrationBuilder.CreateIndex("IX_Transactions_BookId_Currency_Type", "Transactions", new string[3] { "BookId", "Currency", "Type" });
		migrationBuilder.CreateIndex("IX_Transactions_BookId_Date", "Transactions", new string[2] { "BookId", "Date" });
	}

	protected override void Down(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.DropIndex("IX_Transactions_BookId_Currency_Type", "Transactions");
		migrationBuilder.DropIndex("IX_Transactions_BookId_Date", "Transactions");
		Type typeFromHandle = typeof(string);
		migrationBuilder.AlterColumn<string>("Type", "Transactions", "nvarchar(max)", null, null, rowVersion: false, null, nullable: false, null, null, null, typeFromHandle, "nvarchar(450)");
	}
