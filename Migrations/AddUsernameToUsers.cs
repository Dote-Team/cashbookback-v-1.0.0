...
[Migration("20260915123130_AddUsernameToUsers")]
public class AddUsernameToUsers : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		...
		migrationBuilder.AlterColumn<string>("Email", "Users", "nvarchar(256)", null, maxLength, rowVersion: false, null, nullable: false, null, null, null, typeFromHandle, "nvarchar(max)");
		maxLength = 100;
		migrationBuilder.AddColumn<string>("Username", "Users", "nvarchar(100)", null, maxLength, rowVersion: false, null, nullable: false, "");
	...
	protected override void Down(MigrationBuilder migrationBuilder)
	{
		...
		Type typeFromHandle = typeof(string);
		int? oldMaxLength = 256;
		migrationBuilder.AlterColumn<string>("Email", "Users", "nvarchar(max)", null, null, rowVersion: false, null, nullable: false, null, null, null, typeFromHandle, "nvarchar(256)", null, oldMaxLength);
	}
