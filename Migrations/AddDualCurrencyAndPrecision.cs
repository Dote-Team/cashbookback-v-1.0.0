...
[Migration("20260915122235_AddDualCurrencyAndPrecision")]
public class AddDualCurrencyAndPrecision : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.DropIndex("IX_Transactions_BookId", "Transactions");
		int? precision = 18;
		int? scale = 3;
		Type typeFromHandle = typeof(decimal);
		migrationBuilder.AlterColumn<decimal>("Amount", "Transactions", "decimal(18,3)", null, null, rowVersion: false, null, nullable: false, null, null, null, typeFromHandle, "decimal(18,2)", null, null, oldRowVersion: false, oldNullable: false, null, null, null, null, null, null, null, null, null, precision, null, scale);
		scale = 3;
		migrationBuilder.AddColumn<string>("Currency", "Transactions", "nvarchar(3)", null, scale, rowVersion: false, null, nullable: false, "IQD");
		scale = 18;
		precision = 3;
		typeFromHandle = typeof(decimal);
		migrationBuilder.AlterColumn<decimal>("To", "TransactionHistories", "decimal(18,3)", null, null, rowVersion: false, null, nullable: true, null, null, null, typeFromHandle, "decimal(18,2)", null, null, oldRowVersion: false, oldNullable: true, null, null, null, null, null, null, null, null, null, scale, null, precision);
		precision = 18;
		scale = 3;
		typeFromHandle = typeof(decimal);
		migrationBuilder.AlterColumn<decimal>("From", "TransactionHistories", "decimal(18,3)", null, null, rowVersion: false, null, nullable: true, null, null, null, typeFromHandle, "decimal(18,2)", null, null, oldRowVersion: false, oldNullable: true, null, null, null, null, null, null, null, null, null, precision, null, scale);
		scale = 18;
		precision = 3;
		typeFromHandle = typeof(decimal);
		migrationBuilder.AlterColumn<decimal>("Amount", "TransactionHistories", "decimal(18,3)", null, null, rowVersion: false, null, nullable: false, null, null, null, typeFromHandle, "decimal(18,2)", null, null, oldRowVersion: false, oldNullable: false, null, null, null, null, null, null, null, null, null, scale, null, precision);
		migrationBuilder.CreateIndex("IX_Transactions_BookId_Currency", "Transactions", new string[2] { "BookId", "Currency" });
	...
	protected override void Down(MigrationBuilder migrationBuilder)
	{
		...
		migrationBuilder.DropIndex("IX_Transactions_BookId_Currency", "Transactions");
		migrationBuilder.DropColumn("Currency", "Transactions");
		Type typeFromHandle = typeof(decimal);
		int? oldPrecision = 18;
		int? oldScale = 3;
		migrationBuilder.AlterColumn<decimal>("Amount", "Transactions", "decimal(18,2)", null, null, rowVersion: false, null, nullable: false, null, null, null, typeFromHandle, "decimal(18,3)", null, null, oldRowVersion: false, oldNullable: false, null, null, null, null, null, null, null, null, null, null, oldPrecision, null, oldScale);
		typeFromHandle = typeof(decimal);
		oldScale = 18;
		oldPrecision = 3;
		migrationBuilder.AlterColumn<decimal>("To", "TransactionHistories", "decimal(18,2)", null, null, rowVersion: false, null, nullable: true, null, null, null, typeFromHandle, "decimal(18,3)", null, null, oldRowVersion: false, oldNullable: true, null, null, null, null, null, null, null, null, null, null, oldScale, null, oldPrecision);
		typeFromHandle = typeof(decimal);
		oldPrecision = 18;
		oldScale = 3;
		migrationBuilder.AlterColumn<decimal>("From", "TransactionHistories", "decimal(18,2)", null, null, rowVersion: false, null, nullable: true, null, null, null, typeFromHandle, "decimal(18,3)", null, null, oldRowVersion: false, oldNullable: true, null, null, null, null, null, null, null, null, null, null, oldPrecision, null, oldScale);
		typeFromHandle = typeof(decimal);
		oldScale = 18;
		oldPrecision = 3;
		migrationBuilder.AlterColumn<decimal>("Amount", "TransactionHistories", "decimal(18,2)", null, null, rowVersion: false, null, nullable: false, null, null, null, typeFromHandle, "decimal(18,3)", null, null, oldRowVersion: false, oldNullable: false, null, null, null, null, null, null, null, null, null, null, oldScale, null, oldPrecision);
